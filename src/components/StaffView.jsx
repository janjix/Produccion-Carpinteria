...
function PersonPlan({ member, items, planId, staff, projectMap, areaMap, projectColorMap, allMaterialNames, allAreas, onToggle, onMoveDay, onMoveInDay, onRemove, onAdd, onExport, onClear, onToggleDone }) {
  const today = getTodayDayIndex();
