...
// Horas base por proceso. Precarga sugerida al crear tareas manualmente.
// El usuario puede ajustar el valor en cualquier momento.
export const PROCESS_DEFAULT_HOURS = {
  diseno: 4,
  revision_diseno: 1,
  creacion_partidas: 2,
  req_materiales: 1,
  ...
  corte: 2,
  canteado: 1.5,
  supervision_canteado: 0.5,
  mecanizado: 2,
  ensamblaje: 4,
  herrajes: 2,
  supervision_ensamblaje: 1,
  despacho_materiales: 1,
  embalaje: 2,
  instalacion: 6,
  supervision_instalacion: 1,
  despacho_admin: 1,
  mediciones: 2,
  mantenimiento_maquinas: 2,
};
