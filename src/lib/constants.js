...
export const DEFAULT_STAFF_PROCESSES = {
  ...
  AV: ['revision_diseno', 'req_materiales', 'req_herrajes', 'mediciones', 'supervision_instalacion', 'creacion_partidas'],
  DJ: ['modelado', 'optimizacion', 'supervision_ensamblaje'],
  GF: ['supervision_canteado', 'optimizacion', 'despacho_materiales'],
  AL: ['planos', 'modelado'],
  AA: ['canteado', 'mantenimiento_maquinas'],
  CC: ['ensamblaje', 'corte', 'embalaje', 'instalacion'],
};
