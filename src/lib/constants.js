...
// Process → primary responsible staff CODE. Used to resolve who gets propagated tasks.
// Where two people share a process, the primary is listed here; the other acts as backup.
export const PROCESS_PRIMARY_OWNER = {
  ...
  qc: 'AV',
  modelado: 'AL',            // Asdrubal primary; DJ auxiliary
  optimizacion: 'GF',        // GF primary; DJ auxiliary
  supervision_ensamblaje: 'DJ',
  supervision_canteado: 'GF',
  despacho_materiales: 'GF',
  mecanizado: 'GF',
  corte: 'GF',
  planos: 'AL',
  canteado: 'AA',
