...
insert into public.staff (name, code, role, default_processes, color, sort_order) values
  ...
  ('Angel', 'AV', 'Coordinación', '{"revision_diseno","req_materiales","req_herrajes","mediciones","supervision_instalacion","creacion_partidas","qc"}', '#4a9eff', 1),
  ('David', 'DJ', 'Modelado / Supervisión', '{"modelado","optimizacion","supervision_ensamblaje","qc"}', '#7c6df0', 2),
  ('Gian Franco', 'GF', 'Producción', '{"supervision_canteado","optimizacion","despacho_materiales","mecanizado"}', '#2dcc9f', 3),
  ('Asdrubal', 'AL', 'Planos / Modelado', '{"planos","modelado"}', '#f09030', 4),
  ('Ayudantes', 'AA', 'Producción', '{"canteado","mantenimiento_maquinas"}', '#20b8d0', 5),
  ('Carpinteros', 'CC', 'Carpintería', '{"ensamblaje","corte","embalaje","instalacion","herrajes"}', '#e6a23c', 6),
